    ...
    public class PropertyNameInjection : LoopInjection
    {
        ...
        private object GetTargetValue(object source, PropertyInfo sp, PropertyInfo tp)
        {
            ...
            if (sourceVal == null)
                ...
                targetVal = MapICollection(sourceVal, sourceType, targetType);
        ...
        private object MapArray(object sourceVal, Type sourceType, Type targetType)
        {
            ...
            for (int index = 0; index < sourceArray.Length; index++)
            {
                ...
                var targetItem = Activator.CreateInstance(targetItemType).InjectFrom<PropertyNameInjection>(sourceItem);
        ...
        private object MapICollection(object sourceVal, Type sourceType, Type targetType)
        {

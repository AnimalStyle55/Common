...
namespace LD.Common.Security.Crypto
{
    ...
    internal static class Primitives
    {
        ...
        /// <param name="iterations">how 'slow' you want the hash.  More is more secure.  At least 10,000</param>
        /// <returns></returns>
        public static byte[] HmacPBKDF2(string password, byte[] salt, int iterations = 50000)
        {
            ...
            Rfc2898DeriveBytes hasher = new Rfc2898DeriveBytes(password, salt, iterations);
        ...
        public static byte[] HmacPBKDF2(byte[] key, byte[] salt, int outputBytes, int iterations)
        {
            ...
            Rfc2898DeriveBytes hasher = new Rfc2898DeriveBytes(key, salt, iterations);

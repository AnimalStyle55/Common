...
namespace Tests.LD.Common.Logging.NLog.Renderers
{
    ...
    internal class FilteredMessageRendererTest
    {
        ...
        public void Test_HasSsn()
        {
            ...
            Assert.AreEqual("{ \"borrower\": \"buddy\", \"ssn\": \"<REDACTED>\" }", new Renderer().RunIt(lei));
        }
        ...
        public void Test_HasPassword()
        {
            ...
            Assert.AreEqual("{ \"borrower\": \"buddy\", \"password\": \"<REDACTED>\" }", new Renderer().RunIt(lei));
        }
        ...
        public void Test_HasPrefixedPassword()
        {
            ...
            Assert.AreEqual("{ \"borrower\": \"buddy\", \"newPassword\": \"<REDACTED>\" }", new Renderer().RunIt(lei));
        }

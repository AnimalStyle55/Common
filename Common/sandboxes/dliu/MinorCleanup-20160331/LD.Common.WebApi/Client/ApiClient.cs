...
namespace LD.Common.WebApi.Client
{
    ...
    public class ApiClient
    {
        ...
        /// <summary>
        /// Construct from url with RestSharp default timeout
        /// </summary>
        /// <param name="serverUrl">protocal and host:port only</param>
        public ApiClient(string serverUrl) : this(serverUrl, null)
        {
        }
        ...
        public ApiClient(string serverUrl, TimeSpan? timeout)
        {

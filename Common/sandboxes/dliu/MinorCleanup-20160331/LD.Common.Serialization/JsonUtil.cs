...
namespace LD.Common.Serialization
{
    ...
    public static class JsonUtil
    {
        ...
        /// <summary>
        /// Serializes an object to json string using custome serialization settings
        /// </summary>
        /// <param name="obj"></param>
        /// <param name="modSettings">customize the json settings with this action, null for no customization</param>
        /// <returns>json string</returns>
        public static string SerializeObject(object obj, Action<JsonSerializerSettings> modSettings)
        {
        ...
        /// <summary>
        /// Deserializes json string to object using custome serialization settings
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="s"></param>
        /// <param name="modSettings">customize the json settings with this action, null for no customization</param>
        /// <returns>object of type T</returns>
        public static T DeserializeObject<T>(string s, Action<JsonSerializerSettings> modSettings)
        {

...
namespace Tests.LD.Common.Extensions
{
    ...
    internal class StringExtensionsTest
    {
        ...
        public void Test_ToEnumOrDefault()
        {
            ...
            Assert.AreEqual(SimpleEnum.EnumValDefault, "not valid".ToEnumOrDefault<SimpleEnum>(SimpleEnum.EnumValDefault));
            ...
            Assert.AreEqual(FlagsEnum.EnumValNone, "not valid".ToEnumOrDefault<FlagsEnum>(FlagsEnum.EnumValNone));
        }
        ...
        public void Test_ToEnumOrNull()
        {
            ...
            Assert.IsNull("not valid".ToEnumOrNull<SimpleEnum>());
            ...
            Assert.IsNull("not valid".ToEnumOrNull<FlagsEnum>());
        }
    }
}
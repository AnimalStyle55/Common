...
namespace LD.Common.Extensions.Configuration
{
    ...
    public static class StringExtensions
    {
        ...
        /// <returns>The value of the setting as a string.  Returns null if the setting (key) doesn't exist.</returns>
        public static string GetAppSetting(this string setting)
        {
        ...
        public static string GetAppSetting(this string setting, string defaultValue)
        {
        ...
        {
            var value = GetAppSetting(setting);

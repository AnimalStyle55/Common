...
namespace Tests.LD.Common.Security.Crypto
{
    ...
    public class PrimitivesTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => Primitives.HmacPBKDF2(null, HexUtil.ToBytes("1234"), 100));
        }

        [Test]
        public void Test_HmacPBKDF2_Null2()
        {
            Assert.Throws<ArgumentNullException>(() => Primitives.HmacPBKDF2("plain", null, 100));
        }

        [Test]
        public void Test_HmacPBKDF2_IterTooSmall()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => Primitives.HmacPBKDF2("plain", HexUtil.ToBytes("1234"), 0));
        }

        [Test]
        public void Test_HmacPBKDF2_IterToSmall2()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => Primitives.HmacPBKDF2("plain", HexUtil.ToBytes("1234"), -5));
        }

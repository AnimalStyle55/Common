...
namespace Common.Utils
{
    ...
    public static class TimeUtil
    {
        ...
        public enum Zones
        {
            /// <summary>The Common time zone is currently Pacific, use when you want a TZ that represents LD corporate</summary>
            Common,
            /// <summary>EST</summary>
            Eastern,
            /// <summary>CST</summary>
        ...
        static TimeUtil()
        {
            ...
            _tzDict[Zones.Common] = _tzDict[Zones.Pacific];

            _tzDict[Zones.Mountain] = TimeZoneInfo.FindSystemTimeZoneById("Mountain Standard Time");
        ...
        /// </summary>
        public static int CommonUtcOffsetMinutes
        {
            get { return (int)_tzDict[Zones.Common].BaseUtcOffset.TotalMinutes; }
        }
        ...
        public static bool IsCommonTimeInDST(DateTime? time = null)
        {
            return _tzDict[Zones.Common].IsDaylightSavingTime(time.HasValue ? time.Value : DateTime.UtcNow.ToCommonTime());
        }

        /// <summary>
        /// Converts a DateTime in UTC to the Common time zone
        /// </summary>
        /// <param name="time"></param>
        /// <returns></returns>
        public static DateTime ToCommonTime(this DateTime time)
        {
            return FromUtc(time, Zones.Common);
        }
        ...
        public static DateTime? ToCommonTime(this DateTime? time)
        {
            return time == null ? (DateTime?)null : time.Value.ToCommonTime();
        }

        /// <summary>
        /// Returns the current time in the Common time zone
        /// </summary>
        public static DateTime CommonTime
        {
            get { return DateTime.UtcNow.ToCommonTime(); }
        }

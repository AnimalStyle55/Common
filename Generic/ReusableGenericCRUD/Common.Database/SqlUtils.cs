...
namespace Common.Database
{
    ...
    public static class SqlUtils
    {
        ...
        public static int? TimeSpanToMillis(TimeSpan? timespan) => timespan.HasValue ? (int)timespan.Value.TotalMilliseconds : (int?)null;
        ...
        public static TimeSpan? MillisToTimeSpan(int? millis) => millis.HasValue ? TimeSpan.FromMilliseconds(millis.Value) : (TimeSpan?)null;
    }
}